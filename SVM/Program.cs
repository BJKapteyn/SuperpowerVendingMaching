...
namespace SVM
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Power p10 = new Power("Conjure Objects at Will (+- 50m location accuracy)", 199.99, "Mental", "Need a new car? Just make sure you are in an open field...");
            Power p11 = new Power("Ability to Menorize Movies that are Certified Rotten", 10.49, "Mental", "Impress and annoy your friends with you movie choices and monolouges.");
            Power p12 = new Power("Low Altidude, Slow Speed Flying Naked", 1999.99, "Physical", "Shed your clothes for the ability to fly at 6mph, 100ft above the ground.");
